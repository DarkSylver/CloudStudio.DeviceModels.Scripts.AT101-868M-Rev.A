...
# Parsing + Configuration Script – AT101-868M - Rev. A

This **Parsing + Configuration** script is designed for the **AT101-868M** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AT101-868M Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AT101-868M** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
